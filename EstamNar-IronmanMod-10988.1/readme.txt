...
JET 1.1.0, using client 12.9.10988
AE 2.2.0, using client 12.9.10988

This mod should be compatible with most mods currently released. Any future mod that modifies any of the same files or values as my mod, or tampers with the offraid.js, may have compatibility issues. If you find any mods that don't play nice with mine, let me know on any of the Emu discords, or DM me directly. 

INSTALL: Extract folder "EstamNar-IronmanMod-10988.1" into your (server)/user/mods folder. Delete the "cache" folder in (server)/user, and restart the server. 

UNINSTALL: Delete folder "EstamNar-IronmanMod-10988.1" from your (server)/user/mods folder. Delete the "cache" folder in (server)/user, and restart the server. 
...
FEATURES / CHANGELOG:
Update 10988.1
- Updated for compatability with Altered Escape 2.2.0
- Moved to new versioning system, (client version).(mod version)
- Broke compatability with EFT: Rebirth entirely, will support with a separate mod
